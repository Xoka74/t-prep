package com.shurdev.t_prep.presentation.screens.dialogs.addCard
...
import com.shurdev.t_prep.presentation.screens.dialogs.addCard.viewModel.AddCardViewModel
...
fun AddCardDialog(
    ...
    val viewModel = hiltViewModel<AddCardViewModel>()
